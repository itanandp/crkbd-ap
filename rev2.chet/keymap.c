...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|------+------+-------+-------+-------+-------|                |------+------+------+------+------+------|
    KC_LSPO, KC_NO,KC_BTN2,KC_WH_D,KC_WH_U,KC_BTN1,                KC_HOME,KC_PGDN,KC_PGUP,KC_END,KC_NO,KC_RSPC,
  //|------+------+-------+-------+-------+-------+------|  |------+------+------+------+------+------+------|
                               KC_LGUI, LOWER, KC_SPC,   KC_ENT, RAISE, KC_RALT
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
    RGB_MOD,RGB_HUD,RGB_SAD,RGB_VAD,RGB_SPD,KC_CLCK,           KC_SLCK,KC__VOLDOWN, KC_NO, KC_NO, KC_NO, RGB_RMOD,
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                               KC_LGUI, LOWER, KC_SPC,   KC_ENT, RAISE, KC_RALT
                              //`--------------------'  `--------------------'
  )
...
void matrix_init_user(void) {
    ...
    void render_rgb_status(void) {
        static char rgb_info_str[24];
        snprintf(rgb_info_str, sizeof(rgb_info_str), "%s %2d h%3d s%3d v%3d",
            rgb_matrix_config.enable ? "on" : "- ", rgb_matrix_config.mode,
